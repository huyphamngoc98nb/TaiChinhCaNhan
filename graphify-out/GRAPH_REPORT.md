...
## Corpus Check
- 309 files · ~113,186 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2110 nodes · 6838 edges · 141 communities (129 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfc11cc6`
...
Cohesion: 0.05
Nodes (68): CashflowBarChart(), Props, dateInputValue(), DateRangePicker(), endOfInputDate(), Props, startOfInputDate(), ReportDonutCard() (+60 more)

### Community 5 - "Community 5"
Cohesion: 0.27
Nodes (9): generateId(), mapWallet(), WalletReferenceCounts, getReentrantDb(), isReentrantTransactionCall(), nativeTransactionQueue, runExclusive(), runManagedWork() (+1 more)
...
Cohesion: 0.26
Nodes (14): Props, Props, Props, ALL_ACCOUNT_TYPES, BudgetScopePicker(), Props, AccountType, BudgetPeriod (+6 more)

### Community 9 - "Community 9"
Cohesion: 0.19
Nodes (11): CurrencySettings(), DropdownList(), DropdownListProps, DropdownOption, isEditableElement(), amountInput, onChange, AppBackHandler (+3 more)
...
Cohesion: 0.12
Nodes (20): ConfirmContext, ConfirmContextType, ConfirmOptions, ConfirmDialog(), ConfirmDialogProps, BodyScrollLockSnapshot, lockBodyScroll(), shouldUseFixedBodyLock() (+12 more)
...
Cohesion: 0.20
Nodes (12): ACCOUNT_TYPE_ORDER, Props, WalletList(), useCreditCardAlerts(), AccountType, filterActiveWallets(), hasWalletValue(), isActiveWallet() (+4 more)
...
Cohesion: 0.20
Nodes (8): Props, StoredStatement, UseWalletsReturn, CreateWalletInput, UpdateWalletInput, UpsertCreditCardStatementInput, SyncCreditCardStatementUseCase, WalletService

### Community 23 - "Community 23"
Cohesion: 0.26
Nodes (5): Transaction, TransactionFilter, UpdateTransactionInput, InMemoryTransactionRepository, matchesFilter()
...
Cohesion: 0.25
Nodes (4): deps, loan(), makeRepo(), repo
...
Cohesion: 0.19
Nodes (14): CreateTransactionInput, TransactionType, TransactionValidationError, validateCreateTransaction(), validateUpdateTransaction(), getSourceDelta(), validateActiveWallet(), assertActiveWallet() (+6 more)
...
Cohesion: 0.10
Nodes (33): BiometricUnlockSettings(), BudgetAddSheet(), BudgetAlertsPanel(), Props, ACCOUNT_TYPE_ICONS, BudgetByAccountTypeSummary(), Props, STATUS_COLORS (+25 more)

### Community 86 - "Community 86"
Cohesion: 0.21
Nodes (9): TranslationPath, createCreditCardPaymentUseCase, deleteTransactionUseCase, listTransactionsUseCase, ListTransactionsUseCase, localizeMessage(), localizeTransactionError(), MESSAGE_KEYS (+1 more)

### Community 87 - "Community 87"
Cohesion: 0.17
Nodes (17): CreateLoanInput, CreateLoanPaymentInput, LOAN_TYPES, LoanValidationError, validateCreateLoan(), validateLoanFields(), validateUpdateLoan(), baseInput() (+9 more)

### Community 88 - "Community 88"
Cohesion: 0.18
Nodes (17): importBackupJson(), readBackupFile(), restoreDatabase(), assertBackupPayload(), normalizeBackupPayload(), validateBackupPayload(), file, invalid (+9 more)
...
Cohesion: 0.24
Nodes (15): CurrencyAmountInput(), CurrencyAmountInputProps, formatAmountInput(), getFractionDigits(), normalizeAmountInput(), ACCOUNT_TYPE_ICONS, ACCOUNT_TYPES, COLOR_PRESETS (+7 more)
...
Cohesion: 0.14
Nodes (28): immediateTransactionRunner(), sqliteTransactionRunner(), TransactionRunner, validateCreateLoanPayment(), ITransactionRepository, IWalletRepository, addLoanPayment(), AddLoanPaymentDeps (+20 more)
...
Cohesion: 0.14
Nodes (18): ACCOUNT_TYPE_LABELS, Budget, BudgetWithCategory, CreateBudgetDto, resolveBudgetScope(), Wallet, IBudgetRepository, CalculateBudgetProgressUseCase (+10 more)

### Community 111 - "Community 111"
Cohesion: 0.22
Nodes (16): mapBooleanFlag(), mapToLoan(), mapToLoanPayment(), mapToLoanWithSummary(), Loan, LoanFilter, LoanPayment, LoanWithSummary (+8 more)
...
Cohesion: 0.11
Nodes (35): BackButton(), BackButtonProps, BottomSheet(), Props, CategoryList(), TransactionForm(), useConfirm(), ROUTES (+27 more)

### Community 116 - "Community 116"
Cohesion: 0.38
Nodes (8): formatDueDate(), fromDateInput(), isValidDateParts(), parseDueDate(), RecurringBillForm(), startOfLocalDay(), toDateInput(), useWallets()

### Community 117 - "Community 117"
Cohesion: 0.14
Nodes (16): BudgetCategoryItem(), Props, EditableCategoryBudget, Props, SCOPE_ORDER, BudgetProgressCard(), Props, BudgetScopeBadge() (+8 more)
...
Cohesion: 0.27
Nodes (6): createSampleTransactions(), AppRepositories, CreateCreditCardPaymentInput, CreateCreditCardPaymentUseCase, CreateTransactionUseCase, DeleteTransactionUseCase

### Community 120 - "Community 120"
Cohesion: 0.16
Nodes (21): loanListDeps, loanMutationDeps, loanServiceDeps, UpdateLoanInput, emitLoanEvent(), toError(), useLoanMutations(), formatIsoDate() (+13 more)
...
Cohesion: 0.15
Nodes (12): asOf, closedStatementAsOf, creditCard, firstStatement, overdueAsOf, period, repo, statement (+4 more)
...
Cohesion: 0.05
Nodes (57): Props, Props, RecurringBillList(), STATUS_COLORS, formatDaysDiff(), Props, RecurringBillReminderBanner(), STATUS_CONFIG (+49 more)
...
Cohesion: 0.14
Nodes (27): AdvancedTransactionFilterSheet(), DateDisplayInput(), DateDisplayInputProps, dateDisplayInputStyle, dateIconStyle, dateInputShellStyle, endOfLocalDay(), hiddenDateInputStyle (+19 more)

### Community 130 - "Community 130"
Cohesion: 0.18
Nodes (13): dateStringToTimestamp(), LoanForm(), LoanFormProps, startOfLocalDay(), timestampToDateString(), TYPE_OPTIONS, { container }, existingLoan (+5 more)
...
Cohesion: 0.47
Nodes (5): alerts, AS_OF, period(), summary(), wallet()

## Knowledge Gaps
- **475 isolated node(s):** `config`, `dev`, `build`, `typecheck`, `lint` (+470 more)
...
- **Why does `useLanguage()` connect `Community 85` to `Community 129`, `Community 130`, `Community 4`, `Community 133`, `Community 134`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 76`, `Community 86`, `Community 98`, `Community 99`, `Community 107`, `Community 108`, `Community 109`, `Community 115`, `Community 116`, `Community 117`, `Community 120`, `Community 121`, `Community 122`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `getDbConnection()` connect `Community 1` to `Community 131`, `Community 4`, `Community 5`, `Community 8`, `Community 137`, `Community 136`, `Community 139`, `Community 10`, `Community 138`, `Community 23`, `Community 29`, `Community 34`, `Community 48`, `Community 88`, `Community 89`, `Community 106`, `Community 107`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 125`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Wallet` connect `Community 122` to `Community 129`, `Community 1`, `Community 5`, `Community 140`, `Community 13`, `Community 22`, `Community 33`, `Community 73`, `Community 79`, `Community 84`, `Community 87`, `Community 90`, `Community 98`, `Community 106`, `Community 115`, `Community 119`, `Community 123`, `Community 124`, `Community 125`, `Community 126`?**
