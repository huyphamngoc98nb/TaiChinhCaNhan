...
Cohesion: 0.21
Nodes (4): createSampleTransactions(), mapToTransaction(), Transaction, SQLiteTransactionRepository
...
Cohesion: 0.10
Nodes (34): dateInputValue(), DateRangePicker(), endOfInputDate(), Props, startOfInputDate(), dumpReportData(), CashflowSummary, CategorySummary (+26 more)

### Community 5 - "Community 5"
Cohesion: 0.16
Nodes (15): ConfirmContext, ConfirmContextType, ConfirmOptions, ConfirmProvider(), ConfirmDialog(), ConfirmDialogProps, ThemeProvider(), BodyScrollLockSnapshot (+7 more)
...
Cohesion: 0.08
Nodes (53): CurrencyAmountInputProps, formatAmountInput(), getFractionDigits(), getMoneyKeyboardScrollContainer(), MoneyKeyboardScrollState, normalizeAmountInput(), restoreMoneyKeyboardScrollPadding(), CurrencyCode (+45 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (39): DisplayFormatSettings(), previewTimestamp, SettingLabel(), SettingLabelProps, ToggleSetting(), ToggleSettingProps, transaction(), matchingInputs (+31 more)
...
Cohesion: 0.14
Nodes (7): explainReportQueries(), SQLiteCategoryRepository, mapWallet(), SQLiteWalletRepository, ensureBalanceAdjustmentCategory(), getDbConnection(), getDbConnectionForTransaction()
...
Cohesion: 0.11
Nodes (30): CreateTransactionInput, TransactionFilter, TransactionType, UpdateTransactionInput, TransactionValidationError, validateCreateTransaction(), validateUpdateTransaction(), matchesFilter() (+22 more)
...
Cohesion: 0.27
Nodes (18): CURRENCIES, DisplayFormatSettings, formatAppAmount(), formatAppDate(), formatAppDateTime(), formatAppMonth(), formatAppTime(), formatNumberOnly() (+10 more)
...
Cohesion: 0.16
Nodes (16): cancelRestoreFrame(), requestRestoreFrame(), scrollPositions, useScrollRestoration(), CONTEXTUAL_ADD_ROUTES, ContextualAddRoute, DASHBOARD_WITH_DRAWER_BACK_ROUTES, DEFAULT_ADD_ROUTE (+8 more)
...
Cohesion: 0.11
Nodes (24): AppUpdateGate(), confirmMock, showToastMock, PromptUpdateOptions, useAppUpdatePrompt(), checkForAndroidUpdate(), clearSkippedVersion(), fetchLatestAndroidRelease() (+16 more)
...
Cohesion: 0.07
Nodes (45): AuthResult, AuthService, BIOMETRIC_UNLOCK_SUPPORTED_PLATFORMS, BiometricAuthEvent, BiometricListenerPlugin, defaultText(), isAndroidPlatform(), isBiometricUnlockSupportedPlatform() (+37 more)

### Community 85 - "Community 85"
Cohesion: 0.14
Nodes (16): LoadingScreen(), ACTIVITY_EVENTS, AppBootstrap(), AppBootstrapProps, startReceiptCleanup(), AppUnlock(), AppUnlockProps, PIN_KEYS (+8 more)

### Community 86 - "Community 86"
Cohesion: 0.14
Nodes (30): LOAN_TYPES, LoanValidationError, validateCreateLoan(), validateLoanFields(), validateUpdateLoan(), categoryKeySet(), createLoan(), CreateLoanDeps (+22 more)

### Community 87 - "Community 87"
Cohesion: 0.13
Nodes (26): immediateTransactionRunner(), sqliteTransactionRunner(), TransactionRunner, createCreditCardPaymentUseCase, AppRepositories, createSQLiteRepositories(), ITransactionRepository, IWalletRepository (+18 more)
...
Cohesion: 0.15
Nodes (22): BackButton(), BackButtonProps, FormTransition(), RecurringBillForm(), RecurringBillList(), hasStartupRedirectBeenApplied(), markStartupRedirectApplied(), StartupScreenRedirector() (+14 more)
...
Cohesion: 0.17
Nodes (26): BudgetAddSheet(), Props, BudgetEditForm(), Props, BudgetEditSheet(), Props, ALL_ACCOUNT_TYPES, BudgetScopePicker() (+18 more)
...
Cohesion: 0.22
Nodes (13): Props, CategoryList(), Props, Category, CategoryInput, CategoryReferenceCounts, CategoryType, mapCategory() (+5 more)

### Community 106 - "Community 106"
Cohesion: 0.12
Nodes (33): CreditCardAlertsPanel(), ACCOUNT_TYPE_ICONS, ACCOUNT_TYPE_LABELS, formatDayMonth(), Props, WalletCard(), ACCOUNT_TYPES, COLOR_PRESETS (+25 more)

### Community 107 - "Community 107"
Cohesion: 0.13
Nodes (17): BottomSheet(), cancelNextFrame(), prefersReducedMotion(), Props, scheduleNextFrame(), SheetTransitionState, DropdownListProps, DropdownOption (+9 more)

### Community 108 - "Community 108"
Cohesion: 0.20
Nodes (21): CategoryForm(), COLOR_PRESETS, CATEGORY_ICON_LIBRARY_DEFINITIONS, CATEGORY_ICON_PRESET_DEFINITIONS, CategoryIcon(), CategoryIconPreset, CUSTOM_ICON_PRESETS, getCategoryIconKey() (+13 more)
...
Cohesion: 0.11
Nodes (29): RecoveryResetDialog(), BiometricUnlockSettings(), BudgetSummaryStats(), Props, StatCard(), StatCardProps, CurrencySettings(), EmptyBudgetPrompt() (+21 more)

### Community 111 - "Community 111"
Cohesion: 0.16
Nodes (19): BudgetCategoryList(), EditableCategoryBudget, Props, SCOPE_ORDER, BudgetProgressCard(), Props, BudgetProgress, RecurringBillReminder (+11 more)
...
Cohesion: 0.09
Nodes (47): AppUiPreferencesApplier(), ACCOUNT_TYPE_ICONS, BudgetByAccountTypeSummary(), Props, STATUS_COLORS, BudgetCategoryItem(), Props, CashflowBarChart() (+39 more)
...
Cohesion: 0.28
Nodes (9): isDatabaseReady(), canUseLocalStorage(), ErrorLogRepository, generateId(), readPendingErrorLogs(), readPendingLogs(), writePendingLogs(), LogLevel (+1 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (32): ENV, OrphanReceiptCleanupService, runReceiptOrphanCleanup(), ReceiptStorageService, destinationWallet, includeDeletedSpy, readStoredWallet, sourceWallet (+24 more)
...
Cohesion: 0.35
Nodes (14): input, range, addMonths(), coerceMonthDate(), DateRange, endOfMonth(), getMonthDateRange(), getWeekDateRange() (+6 more)
...
Cohesion: 0.16
Nodes (12): escapeCsvCell(), exportToCsv(), formatCsvDate(), csv, dataset, json, lines, mockReportRepo (+4 more)
...
Cohesion: 0.14
Nodes (22): LoanType, validateCreateLoanPayment(), addLoanPayment(), AddLoanPaymentDeps, defaultText(), LoanPaymentExceedError, PAYMENT_CATEGORY, category() (+14 more)
...
Cohesion: 0.14
Nodes (25): BudgetStatusBadge(), Props, BudgetStatus, resolveBudgetScope(), BUDGET_THRESHOLDS, classifyBudgetStatus(), BUDGET_STATUS_ORDER, BudgetUsageMetric (+17 more)
...
Cohesion: 0.20
Nodes (8): { container }, { container, onChange }, dateInput, messages, { onChange }, renderPicker(), timeInput, renderLoanForm()

### Community 162 - "Community 162"
Cohesion: 0.43
Nodes (4): AppProvider(), notifyAppError(), installGlobalErrorLogging(), toMetadataValue()
...
Cohesion: 0.08
Nodes (36): formatDueDate(), fromDateInput(), isValidDateParts(), parseDueDate(), Props, startOfLocalDay(), toDateInput(), Props (+28 more)
...
## Knowledge Gaps
- **647 isolated node(s):** `config`, `dev`, `build`, `typecheck`, `lint` (+642 more)
...
- **Why does `Wallet` connect `Community 106` to `Community 129`, `Community 99`, `Community 8`, `Community 73`, `Community 141`, `Community 13`, `Community 111`, `Community 143`, `Community 23`, `Community 86`, `Community 87`, `Community 88`, `Community 90`, `Community 123`, `Community 127`?**
